...
for k in freq_dict.keys():
    ...
    for point_pair in point_pairs:
        ...
        point1 = point_pair[0]
        point2 = point_pair[1]
        antinode_y1,antinode_x1 = 2*point1[0]-point2[0], 2*point1[1]-point2[1]
        antinode_y2,antinode_x2 = 2*point1[0]+point2[0], 2*point1[1]-point2[1]
        antinode_y3,antinode_x3 = 2*point1[0]-point2[0], 2*point1[1]+point2[1]
        antinode_y4,antinode_x4 = 2*point1[0]+point2[0], 2*point1[1]+point2[1]
        antinode_y5,antinode_x5 = 2*point2[0]-point1[0], 2*point2[1]-point1[1]
        antinode_y6,antinode_x6 = 2*point2[0]+point1[0], 2*point2[1]-point1[1]
        antinode_y7,antinode_x7 = 2*point2[0]-point1[0], 2*point2[1]+point1[1]
        antinode_y8,antinode_x8 = 2*point2[0]+point1[0], 2*point2[1]+point1[1]
